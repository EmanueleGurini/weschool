    ...
    <div className="w-full text-white bg-[#1C2C47] ">
      <div className="container mx-auto flex md:flex-row items-center justify-between p-4">
        ...
        <nav className="flex space-x-4">
          <Link href="/dashboard/teacher/note">
            <Image width={50} height={50} src="/img/promotion.png" alt="Comunicazioni" className="w-11 h-11 hover:opacity-75 border border-color-black rounded-full p-2" />
          </Link>
          <Link href="/account">
